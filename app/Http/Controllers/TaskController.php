...
class TaskController extends Controller
{
    ...
    //     $task = Task::where("iscompleted", false)->orderBy("id", "DESC")->get();
    //     $completed_task = Task::where("iscompleted", true)->get();
    ...
    //     $task->save();
    //     return Redirect::back()->with("messsage", "Task has been added");
